...
export const PrivateLayout = () => {
  return (
    <div className="h-screen w-full flex overflow-hidden">
      {/* Sidebar */}
      <aside className="w-60 hidden md:block border-r relative">
        <LeftMenu />
      </aside>
      {/* Right side */}
      <div className="flex-1 min-w-0 min-h-0 h-full flex flex-col overflow-hidden">
        <header className="p-4 border-b border-b-gray-400 flex items-center  sticky top-0">
          <span className="h-10 w-10  rounded-full ml-auto" />
        </header>
